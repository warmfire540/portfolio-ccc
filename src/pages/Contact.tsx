  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative py-20 bg-indigo-900 text-white overflow-hidden">
        ...
        <div className="absolute -bottom-24 right-24 w-64 h-64 rounded-full bg-indigo-500 opacity-20 blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Connect Online</h3>
