  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-8 md:mb-0 md:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/services" className="px-6 py-3 bg-white text-indigo-900 font-semibold rounded-md hover:bg-gray-100 transition-colors text-center">
                  Our Services
                </Link>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">About Curious Cat Consulting</h2>
            ...
            <Link to="/about" className="inline-block px-6 py-3 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-700 transition-colors">
              Learn More About Us
            </Link>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Why Choose Curious Cat Consulting?</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-indigo-600">
              <h3 className="text-xl font-bold text-gray-800 mb-3">Partnership Approach</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 bg-indigo-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/contact" className="inline-block px-6 py-3 bg-white text-indigo-800 font-semibold rounded-md hover:bg-gray-100 transition-colors text-lg">
            Get In Touch
          </Link>
        </div>
      </section>
